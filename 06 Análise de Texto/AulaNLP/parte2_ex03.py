...
print('Carregando Frequência das Classes NER e POS de livro1 FILTRADO')
...
print('Carregando Frequência das Classes NER e POS de livro2 FILTRADO')
...
print('Gerando vocabulário comum entre livro1 e livro2')
...
print('Gerando palavras em comum entre livro1 e livro2')
...
print('Gerando entidades em comum entre livro1 e livro2')
